# Databus Mods [![Java 8 CI with Maven](https://github.com/dbpedia/databus-mods/actions/workflows/maven-java-8.yml/badge.svg)](https://github.com/dbpedia/databus-mods/actions/workflows/maven-java-8.yml)
